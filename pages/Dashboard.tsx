...
const Dashboard = ({ projects = [], folders = [], onRefresh }: any) => {
  ...
  const handleCreateFolder = async () => {
    ...
    if (error) {
      ...
      // ESTO HACE QUE SE VEA EL CAMBIO AL INSTANTE
      ...
      <div className="flex-1 p-10">
        <div className="flex justify-between items-center mb-10 bg-white p-8 rounded-[2rem] shadow-sm border-b-4 border-rose-600">
          ...
          <div className="flex gap-4">
            ...
            <button className="px-8 py-3 bg-rose-600 text-white rounded-2xl font-black text-[10px] uppercase shadow-lg shadow-rose-200">SUBIR FOLLETO</button>
          </div>
        </div>
